...
class Batch(AttrDict):
    ...
    def __init__(self, text_vec=None, text_lengths=None,
                 ...
                 image=None, observations=None, movies=None, turn=None, abstract_m=None, abstract_mask=None,
                 knowledge_label=None, label_movie=None, **kwargs):
        super().__init__(
            ...
            abstract_m=abstract_m, abstract_mask=abstract_mask,
            knowledge_label=knowledge_label, label_movie=label_movie, **kwargs)
