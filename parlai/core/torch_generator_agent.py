...
class TorchGeneratorAgent(TorchAgent):
    ...
    def reset_metrics(self):
        ...
        self.metrics['knowledge_loss'] = 0.0
        self.metrics["accuracy"] = 0.0
        self.metrics['num_pre'] = 0
        self.metrics['recall'] = 0
        self.metrics['recall@count'] = 0
        self.metrics['dist1'] = 0.0
        self.metrics['dist2'] = 0.0
        self.metrics['dist3'] = 0.0
        self.metrics['dist4'] = 0.0
        self.metrics['dist5'] = 0.0
        self.metrics['kg_voc_loss'] = 0.0
        self.metrics['bag_of_entity_loss'] = 0.0
